// Static content for the Wine School / Education page.
// Extracted from src/pages/Education.jsx to keep the page focused on rendering.
...
export const WHITE_DIFFERENCES = [
...
export const PRESERVATION_TECH = [
  {
    icon: '🔬',
