...
const VENUES = [
  ...
  {
    id: 'swan-and-anchor',
    name: 'The Swan and the Anchor',
    town: 'Walton-on-Thames',
    area: 'Riverside / central vibe',
    type: 'Pub + restaurant',
    note: 'Summer favourite',
    vibe: 'Great atmosphere and location, especially in summer.',
    whyAmandaLovesIt: 'Atmosphere plus location make it one of her strongest seasonal picks for long evenings.',
    bestFor: ['Summer evenings', 'Outdoor vibe', 'Friends visiting'],
